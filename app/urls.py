...
from .views import template_view, index_view, login_view, register_view, \
    logout_view, user_detail_view, get_text_json, MyTemplView, MyTemplateView, MyFormView, MyLoginView
...
urlpatterns = [
    ...
    path('login/', MyLoginView.as_view(template_name='app/login.html', redirect_authenticated_user=True), name='login'),
